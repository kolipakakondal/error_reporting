    ...
    public static class PrettyPrintVisitor extends VisitorImpl {
        ...
        private void appendAttributes(EObject object, StringBuilder builder) {
            for (EAttribute attribute : object.eClass().getEAllAttributes()) {
                String line = String.format("%-" + RIGHT_PADDING + "s", attribute.getName() + ":") + object.eGet(attribute) + "\n";
                builder.append(line);
            }
            builder.append("\n");
        }
        ...
        @Override
        public void visit(org.eclipse.epp.internal.logging.aeri.ui.model.Bundle bundle) {
