...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
     ...
     * @generated
     */
    public List<String> createListOfStrings(final String it) {
        Splitter _on = Splitter.on(";");
        Splitter _omitEmptyStrings = _on.omitEmptyStrings();
        Splitter _trimResults = _omitEmptyStrings.trimResults();
        return _trimResults.splitToList(it);
    }
    ...
    public List<String> createListOfStringsFromString(EDataType eDataType, String initialValue) {
        return createListOfStrings(initialValue);
    }
     ...
     * @generated
     */
    public String convertListOfStrings(final List<String> it) {
    ...
    public String convertListOfStringsToString(EDataType eDataType, Object instanceValue) {
        return convertListOfStrings((List<String>) instanceValue);
    }
