...
import static org.eclipse.epp.internal.logging.aeri.ui.ErrorReportsDTOs.createStackTraceElement;
import static org.eclipse.epp.internal.logging.aeri.ui.ErrorReportsDTOs.createStacktraceForClasses;
import static org.eclipse.epp.internal.logging.aeri.ui.ErrorReportsDTOs.createTestReport;
import static org.eclipse.epp.internal.logging.aeri.ui.ErrorReportsDTOs.createThrowable;
...
import org.eclipse.epp.internal.logging.aeri.ui.ErrorReportsDTOs;
import org.eclipse.epp.internal.logging.aeri.ui.utils.ErrorReports;
import org.eclipse.epp.internal.logging.aeri.ui.utils.ErrorReports.AnonymizeStacktraceVisitor;
...
public class ErrorReportsTest {
    ...
    public void testFingerprint() {
        ...
        org.eclipse.epp.internal.logging.aeri.ui.model.Status noCause = ErrorReports.newStatus(s1, settings);
        org.eclipse.epp.internal.logging.aeri.ui.model.Status withCause = ErrorReports.newStatus(s2, settings);
    ...
    public void testFingerprintNested() {
        ...
        org.eclipse.epp.internal.logging.aeri.ui.model.Status normal = ErrorReports.newStatus(s1, settings);
        org.eclipse.epp.internal.logging.aeri.ui.model.Status multi = ErrorReports.newStatus(s2, settings);
    ...
    public void testCoreExceptionHandling() {
        ...
        org.eclipse.epp.internal.logging.aeri.ui.model.Status rootStatus = ErrorReports.newStatus(rootEvent, settings);
    ...
    public void testMultistatusDuplicateChildFiltering() {
        ...
        e2.setStackTrace(ErrorReportsDTOs.createStacktraceForClasses("java.lang.Object", "org.eclipse.core.internal.jobs.WorkerPool",
                "org.eclipse.core.internal.jobs.WorkerPool", "org.eclipse.core.internal.jobs.Worker"));
        ...
        org.eclipse.epp.internal.logging.aeri.ui.model.Status newStatus = ErrorReports.newStatus(multi, settings);
