...
public class LogErrorsAction implements IWorkbenchWindowActionDelegate {
    ...
    private void logManyDifferentErrors() {
        for (int k = 0; k < 10; k++) {
            ...
            log.log(new Status(IStatus.ERROR, "org.eclipse.epp.logging.aeri", "error", ex));
        }
    }
        ...
        for (int i = 0; i < 100000; i++) {
            pool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    ex.setStackTrace(trace);
                    final Status status = new Status(IStatus.ERROR, "org.eclipse.epp.logging.aeri", "error", ex);
